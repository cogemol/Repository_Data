...
1. Datenexport aus PuRe für Skripte via Openrefine (pdf)
2. PuRe_Rohdatenextrag (jpynb)
3. Abfrage_Gleichstellungsplan (jpynb)
4. Abfrage_OpenAccess (jpynb)

Daten werden im Ordner "Daten" abgelegt und Ausgabedokumente befinden sich ebenfalls hier
